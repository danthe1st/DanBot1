...
public class SudoMessageBuilder extends MessageBuilder{
	private Message oldMsg;
	private String display;
	private String raw;
	private String stripped;
	private Member member;
	public SudoMessageBuilder(Message msg,String raw,String display,String stripped,Member author) {
		super(msg);
		oldMsg=msg;
	...
	public Message build() {
        ...
        return new SudoMessage(oldMsg,raw,display,stripped,member);
	}
	
	private class SudoMessage implements Message{
		private Message oldMsg;
		private String display;
		private String raw;
		private String stripped;
